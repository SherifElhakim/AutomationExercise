...
public class TestCase024 {
    ...
    public void DownloadInvoice() throws FileNotFoundException {
        ...
        //Clicking Proceed to Checkout And Clicking 'Register / Login' button then Verifying the Visibility of Login Page
        new CartPage(getDriver()).ClickProceedToCheckoutButton();
        new CartPage(getDriver()).ClickRegisterLoginAfterCheckout();
        ...
        //Verifying "logged as" text Visibility, Clicking Proceed again and filling data
        ...
        //Verifying Visibility Of OrderConfirmed Message And Downloading Invoice then Deleting Account
        Assert.assertTrue(new PaymentDonePage(getDriver()).VerifyOrderConfirmedMessageVisibility());

        new PaymentDonePage(getDriver()).ClickDownloadInvoiceButton()
